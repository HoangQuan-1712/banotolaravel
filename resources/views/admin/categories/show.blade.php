                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-primary">{{ $category->products->count() }} xe</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <div class="card h-100 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                <small class="text-muted">
                                                    <i class="fas fa-boxes"></i> Tồn kho: {{ $product->quantity }} chiếc
                                                </small>
                                            </p>
                                        ...
                                        <div class="card-footer bg-transparent">
                                            <div class="btn-group w-100" role="group">
                                                                                <a class="btn btn-info btn-sm" href="{{ route('admin.products.show', $product->id) }}" title="Xem Chi Tiết Xe">
