    ...
    <div class="row">
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('categories.index') }}"><i class="fas fa-home"></i> Trang chủ</a></li>
                        ...
                        <div>
                            @auth
                                @if (auth()->user()->isAdmin())
                                    <a class="btn btn-light btn-sm me-2" href="{{ route('admin.products.edit', $product->id) }}">
                            ...
                            <div class="product-gallery p-4">
                                ...
                                <div class="thumbnail-gallery">
                                    ...
                                    @auth
                                            @if (auth()->user()->isAdmin())
                                                <div class="col-3">
                                                    <div class="thumbnail-placeholder" onclick="alert('Tính năng thêm ảnh sẽ được phát triển sau')">
                                    ...
                                    <div class="add-to-cart-section mb-4">
                                            ...
                                            <div class="row align-items-end">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="quantity-input-group">
                                                        ...
                                                        <input type="number" name="quantity" id="quantity" value="1" min="1" max="{{ $product->available_stock }}" class="form-control quantity-input">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <form action="{{ route('wishlist.toggle', $product) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn {{ $isInWishlist ? 'btn-danger' : 'btn-outline-danger' }} btn-lg w-100">
                                        ...
                                        <div class="product-info-section">
                                            ...
                                            <div class="info-grid">
                                                ...
                                                <div class="info-item">
                                                    ...
                                                    <span class="info-value text-break">{{ $product->image ?? 'Không có ảnh' }}</span>
                                                </div>
                                                <div class="info-item">
                                                ...
                                                <div class="info-item">
                                                    ...
                                                    <span class="info-value">{{ $product->hasImage() ? '✅ Có' : '❌ Không' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="{{ $product->image_url }}" class="img-fluid" alt="{{ $product->name }}" onerror="this.src='{{ asset('images/default-car.svg') }}'">
            </div>
        </div>
    </div>
</div>
