                    ...
                    <form method="POST" action="{{ route('user.addresses.update', $address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('address_line_1') is-invalid @enderror" 
                                   ...
                                   placeholder="Số nhà, tên đường..." value="{{ old('address_line_1', $address->address_line_1) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('address_line_2') is-invalid @enderror" 
                                   ...
                                   placeholder="Tòa nhà, căn hộ, ghi chú..." value="{{ old('address_line_2', $address->address_line_2) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ward') is-invalid @enderror" 
                                           id="ward" name="ward" value="{{ old('ward', $address->ward) }}" required>
                                    @error('ward')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
